...
<div id="main">
    ...
    <div class="container">
        <div class="bgPic"><img src="<%=request.getContextPath()%>/js/loginAngRegister/img/register/b3_1.jpg" alt=""/>
        </div>
        <div class="register">
            <div class="title">
                <span>登录</span>
                ...
                <div class="icon">
                    <ul>
                        <li data-log="icon" class="i_hover">
                            <img data-icon="wx"
                                 src="<%=request.getContextPath()%>/js/loginAngRegister/img/register/wx.png" alt=""/>
                            <span class="prompt">微信登录</span>
                        </li>
                        <li data-log="icon" class="i_hover">
                            <img data-icon="qq"
                                 src="<%=request.getContextPath()%>/js/loginAngRegister/img/register/qq.png" alt=""/>
                            <span class="prompt">QQ登录</span>
                        </li>
                        <li data-log="icon" class="i_hover">
                            <img data-icon="wb"
                                 src="<%=request.getContextPath()%>/js/loginAngRegister/img/register/wb.png" alt=""/>
